...
func (b *logicalPropsBuilder) buildScanProps(scan *ScanNode, rel *props.Relational) {
...
func (b *logicalPropsBuilder) buildVirtualScanProps(scan *VirtualScanNode, rel *props.Relational) {
	// Output Columns
	// --------------
...
func (b *logicalPropsBuilder) buildSelectProps(sel *SelectNode, rel *props.Relational) {
...
func (b *logicalPropsBuilder) buildProjectProps(prj *ProjectNode, rel *props.Relational) {
...
func (b *logicalPropsBuilder) buildInnerJoinProps(join *InnerJoinNode, rel *props.Relational) {
	b.buildJoinProps(join, rel)
}

func (b *logicalPropsBuilder) buildLeftJoinProps(join *LeftJoinNode, rel *props.Relational) {
	b.buildJoinProps(join, rel)
}

func (b *logicalPropsBuilder) buildRightJoinProps(join *RightJoinNode, rel *props.Relational) {
	b.buildJoinProps(join, rel)
}

func (b *logicalPropsBuilder) buildFullJoinProps(join *FullJoinNode, rel *props.Relational) {
	b.buildJoinProps(join, rel)
}

func (b *logicalPropsBuilder) buildSemiJoinProps(join *SemiJoinNode, rel *props.Relational) {
	b.buildJoinProps(join, rel)
}

func (b *logicalPropsBuilder) buildAntiJoinProps(join *AntiJoinNode, rel *props.Relational) {
	b.buildJoinProps(join, rel)
}

func (b *logicalPropsBuilder) buildInnerJoinApplyProps(
	join *InnerJoinApplyNode, rel *props.Relational,
) {
	b.buildJoinProps(join, rel)
}

func (b *logicalPropsBuilder) buildLeftJoinApplyProps(
	join *LeftJoinApplyNode, rel *props.Relational,
) {
	b.buildJoinProps(join, rel)
}

func (b *logicalPropsBuilder) buildRightJoinApplyProps(
	join *RightJoinApplyNode, rel *props.Relational,
) {
	b.buildJoinProps(join, rel)
}

func (b *logicalPropsBuilder) buildFullJoinApplyProps(
	join *FullJoinApplyNode, rel *props.Relational,
) {
	b.buildJoinProps(join, rel)
}

func (b *logicalPropsBuilder) buildSemiJoinApplyProps(
	join *SemiJoinApplyNode, rel *props.Relational,
) {
	b.buildJoinProps(join, rel)
}

func (b *logicalPropsBuilder) buildAntiJoinApplyProps(
	join *AntiJoinApplyNode, rel *props.Relational,
) {
	b.buildJoinProps(join, rel)
}

func (b *logicalPropsBuilder) buildJoinProps(join RelNode, rel *props.Relational) {
	...
	if opt.IsJoinApplyOp(join) {
		...
		// right input.
		rightOuterCols := join.Child(1).(RelNode).Relational().OuterCols
...
func (b *logicalPropsBuilder) buildIndexJoinProps(indexJoin *IndexJoinNode, rel *props.Relational) {
...
func (b *logicalPropsBuilder) buildLookupJoinProps(join *LookupJoinNode, rel *props.Relational) {
	b.buildJoinProps(join, rel)
}

func (b *logicalPropsBuilder) buildMergeJoinProps(join *MergeJoinNode, rel *props.Relational) {
	panic("no relational properties for merge join node")
}

func (b *logicalPropsBuilder) buildGroupByProps(groupBy *GroupByNode, rel *props.Relational) {
	b.buildGroupingNodeProps(groupBy, rel)
}

func (b *logicalPropsBuilder) buildScalarGroupByProps(
	scalarGroupBy *ScalarGroupByNode, rel *props.Relational,
) {
	b.buildGroupingNodeProps(scalarGroupBy, rel)
}

func (b *logicalPropsBuilder) buildDistinctOnProps(
	distinctOn *DistinctOnNode, rel *props.Relational,
) {
	b.buildGroupingNodeProps(distinctOn, rel)
}

func (b *logicalPropsBuilder) buildGroupingNodeProps(groupNode RelNode, rel *props.Relational) {
	BuildSharedProps(b.mem, groupNode, &rel.Shared)

	inputProps := groupNode.Child(0).(RelNode).Relational()
	aggs := *groupNode.Child(1).(*AggregationsExpr)
	groupPrivate := groupNode.Private().(*GroupingPrivate)
	...
	// Statistics
	// ----------
	b.sb.buildGroupBy(groupNode, rel)
}

func (b *logicalPropsBuilder) buildUnionProps(union *UnionNode, rel *props.Relational) {
	b.buildSetProps(union, rel)
}

func (b *logicalPropsBuilder) buildIntersectProps(isect *IntersectNode, rel *props.Relational) {
	b.buildSetProps(isect, rel)
}

func (b *logicalPropsBuilder) buildExceptProps(except *ExceptNode, rel *props.Relational) {
	b.buildSetProps(except, rel)
}

func (b *logicalPropsBuilder) buildUnionAllProps(union *UnionAllNode, rel *props.Relational) {
	b.buildSetProps(union, rel)
}

func (b *logicalPropsBuilder) buildIntersectAllProps(
	isect *IntersectAllNode, rel *props.Relational,
) {
	b.buildSetProps(isect, rel)
}

func (b *logicalPropsBuilder) buildExceptAllProps(except *ExceptAllNode, rel *props.Relational) {
	b.buildSetProps(except, rel)
}

func (b *logicalPropsBuilder) buildSetProps(setNode RelNode, rel *props.Relational) {
	BuildSharedProps(b.mem, setNode, &rel.Shared)

	leftProps := setNode.Child(0).(RelNode).Relational()
	rightProps := setNode.Child(1).(RelNode).Relational()
...
func (b *logicalPropsBuilder) buildValuesProps(values *ValuesNode, rel *props.Relational) {
...
func (b *logicalPropsBuilder) buildExplainProps(explain *ExplainNode, rel *props.Relational) {
...
func (b *logicalPropsBuilder) buildShowTraceForSessionProps(
	showTrace *ShowTraceForSessionNode, rel *props.Relational,
) {
...
func (b *logicalPropsBuilder) buildLimitProps(limit *LimitNode, rel *props.Relational) {
...
func (b *logicalPropsBuilder) buildOffsetProps(offset *OffsetNode, rel *props.Relational) {
...
func (b *logicalPropsBuilder) buildMax1RowProps(max1Row *Max1RowNode, rel *props.Relational) {
...
func (b *logicalPropsBuilder) buildRowNumberProps(rowNum *RowNumberNode, rel *props.Relational) {
...
func (b *logicalPropsBuilder) buildZipProps(zip *ZipNode, rel *props.Relational) {
...
func BuildSharedProps(mem *Memo, nd opt.Node, shared *props.Shared) {
	switch t := nd.(type) {
	case *VariableExpr:
	...
	case *SubqueryExpr, *ExistsExpr, *AnyExpr:
		...
		shared.HasCorrelatedSubquery = !nd.Child(0).(RelNode).Relational().OuterCols.Empty()
	...
	for i, n := 0, nd.ChildCount(); i < n; i++ {
		...
		// Some nodes cache shared properties.
		...
		if cached != nil {
			...
			BuildSharedProps(mem, nd.Child(i), shared)
		}
	}
}
...
func (b *logicalPropsBuilder) ensureLookupJoinInputProps(join *LookupJoinNode) *props.Relational {
...
func (h *joinPropsHelper) init(b *logicalPropsBuilder, join RelNode) {
	h.join = join
	h.leftProps = join.Child(0).(RelNode).Relational()

	lookupJoin, ok := join.(*LookupJoinNode)
	if !ok {
		h.joinType = join.Op()
		h.rightProps = join.Child(1).(RelNode).Relational()

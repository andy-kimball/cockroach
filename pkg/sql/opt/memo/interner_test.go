...
func TestInterner(t *testing.T) {
	...
	testCases := []struct {
		...
		{hashFn: in.hashRelNode, eqFn: in.isRelNodeEqual, variations: []testVariation{
			{val1: (*ScanNode)(nil), val2: (*ScanNode)(nil), equal: true},
			{val1: scanNode, val2: scanNode, equal: true},
			{val1: &ScanNode{}, val2: &ScanNode{}, equal: false},
		}},

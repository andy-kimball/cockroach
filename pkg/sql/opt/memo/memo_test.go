...
//	flags := memo.NodeFmtHideCost | memo.NodeFmtHideRuleProps | memo.NodeFmtHideQualifications |
//		memo.NodeFmtHideStats
//	runDataDrivenTest(t, "testdata/memo", flags)
//}
//
//func TestLogicalProps(t *testing.T) {
//	flags := memo.NodeFmtHideCost | memo.NodeFmtHideQualifications | memo.NodeFmtHideStats
//	runDataDrivenTest(t, "testdata/logprops/", flags)
//}
//
//func TestStats(t *testing.T) {
//	flags := memo.NodeFmtHideCost | memo.NodeFmtHideRuleProps | memo.NodeFmtHideQualifications |
//		memo.NodeFmtHideScalars
...
//func runDataDrivenTest(t *testing.T, path string, fmtFlags memo.NodeFmtFlags) {
//	datadriven.Walk(t, path, func(t *testing.T, path string) {
//		catalog := testcat.New()
//		datadriven.RunTest(t, path, func(d *datadriven.TestData) string {
//			tester := testutils.NewOptTester(catalog, d.Input)
//			tester.Flags.NodeFormat = fmtFlags
